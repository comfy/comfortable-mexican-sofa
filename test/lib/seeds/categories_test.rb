...
class SeedsCategoriesTest < ActiveSupport::TestCase

  def test_creation
    Comfy::Cms::Category.destroy_all
    assert_difference 'Comfy::Cms::Category.count', 3 do
      ComfortableMexicanSofa::Seeds::Category::Importer.new('sample-site', 'default-site').import!
  ...
  def test_export
    ...
    ComfortableMexicanSofa::Seeds::Category::Exporter.new('default-site', 'test-site').export!

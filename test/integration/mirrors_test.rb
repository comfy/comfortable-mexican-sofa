...
class MirrorsIntegrationTest < ActionDispatch::IntegrationTest
  ...
  def test_get_layouts
    http_auth :get, cms_site_layouts_path(@site_a)
  ...
  def test_get_layouts_edit
    ...
    http_auth :get, edit_cms_site_layout_path(@site_a, layout)
    assert_response :success
    assert_select 'select#mirror' do
  ...
  def test_get_pages
    http_auth :get, cms_site_pages_path(@site_a)
    assert_response :success
    assert_select 'select#mirror' do
  ...
  def test_get_pages_edit
    ...
    http_auth :get, edit_cms_site_page_path(@site_a, page)
    assert_response :success
    assert_select 'select#mirror' do
  ...
  def test_get_snippets
    http_auth :get, cms_site_snippets_path(@site_a)
    assert_response :success
    assert_select 'select#mirror' do
  ...
  def test_get_snippets_edit
    ...
    http_auth :get, edit_cms_site_snippet_path(@site_a, snippet)
    assert_response :success
    assert_select 'select#mirror' do
